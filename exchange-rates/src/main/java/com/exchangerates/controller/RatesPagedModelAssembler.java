...
class RatesPagedModelAssembler {
  ...
  private final PagedResourcesAssembler<Rates> assembler;

  @Autowired
  public RatesPagedModelAssembler(PagedResourcesAssembler<Rates> assembler){
   ...
   */
  private void addCommonLinks(PagedModel<EntityModel<Rates>> model, String charCode, Pageable pageable){
   ...
   * @param pageable must not be {@literal null}.
   */
  private void addLinksToDaysPage(PagedModel<EntityModel<Rates>> model, String charCode, Pageable pageable){
   ...
   * @param pageable must not be {@literal null}.
   */
  private void addLinksToMonthPage(PagedModel<EntityModel<Rates>> model, String charCode, Pageable pageable){
   ...
   * @param pageable must not be {@literal null}.
   */
  private void addLinksToWeekPage(PagedModel<EntityModel<Rates>> model, String charCode, Pageable pageable){
